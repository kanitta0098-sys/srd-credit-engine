...
with left_col:
 ...
 st.markdown(f'<div class="estimated-box"><div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:10px;"><div><div style="font-size:11px;background:#0F172A;color:#7DD3FC;padding:3px 10px;border-radius:12px;display:inline-block;margin-bottom:8px;border:1px solid #075985;">ยอดผ่อนต่อเดือน</div><div style="font-size:28px;font-weight:800;color:white;">{monthly_instalment:,.2f} บาท / เดือน</div></div><div style="text-align:right;font-size:13px;color:#E0F2FE;"><div>ดอกเบี้ยรวม: <b style="color:white;">{total_interest:,.0f}</b></div><div>ยอดรวม: <b style="color:white;">{total_payable:,.0f}</b></div><div>ทะเบียน พรบ ประกัน: <b style="color:white;">{st.session_state.processing_fee:,.0f}</b></div></div></div></div>', unsafe_allow_html=True)
